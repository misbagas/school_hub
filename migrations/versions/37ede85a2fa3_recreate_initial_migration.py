...
Revision ID: 37ede85a2fa3
Revises: 
Create Date: 2025-02-04 16:54:56.555705
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], name='forum_codes_ibfk_1'),
